...
static constexpr const char *const TAG = "Ebms-webpost";
...
esp_err_t post_savecurrentmon_json_handler(httpd_req_t *req, bool urlEncoded)
{
    ...
    if (mysettings.currentMonitoringEnabled == false)
    {
        ...
        mysettings.currentMonitoringDevice = CurrentMonitorDevice::EBMS_CURRENT_MON_MODBUS;
