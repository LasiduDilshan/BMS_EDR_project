...
$("#currentmonitor").text("EBMS-currentshunt");
$("#storage").text("opslag");
...
$("#rt1").text("EBMS ondersteunt relais om veilig laders, contactors en verbruikers te schakelen. De regels onderaan laten toe ze instellen voor jouw situatie");
...
$("#ap6").text("Dit is een E product/oplossing, gebruik het niet in veiligheidskritische systemen of in een situatie waarbij het levensbedreigend kan zijn");
...
$("#mb2").text("EBMS ondersteunt maximaal 100 modules in totaal.  Deze modules kunnen opgesplitst worden in verschillende banken t.b.v. een parallele configuratie");
...
$("#EbmsCurrentMonitorPage > h1").text("EBMS Stroom & Spanningsbewaking");
