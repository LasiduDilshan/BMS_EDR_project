...
$("#rt1").text("EBMS prend en charge les modules de relais pour déconnecter en toute sécurité les chargeurs, les contacteurs ou les consommateurs. Les règles permettent de configurer les relais selon votre installation.");
...
$("#mb2").text("EBMS prend en charge jusqu'à 128 modules au total. Ces modules peuvent être divisés en chaines pour prendre en charge des configurations parallèles.");
