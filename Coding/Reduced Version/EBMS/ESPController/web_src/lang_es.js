...
$("#currentmonitor").text("EBMS monitoreo de amperaje");
...
$("#rt1").text("EBMS admite módulos de relé para desconectar de forma segura cargadores, contactores o consumos. Las reglas le permiten configurar los relés para su situación.");
...
$("#ap6").text("This is a E product/solution so don’t use this for safety critical systems or in any situation where there could be a risk to life.");
...
$("#mb2").text("EBMS supports up to 100 modules in total. These modules can be split into banks to support parallel configurations.");
