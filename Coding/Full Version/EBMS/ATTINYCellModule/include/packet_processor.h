#ifndef EBMS_PACKETPROCESSOR_H // include guard
#define EBMS_PACKETPROCESSOR_H

#include <Arduino.h>

/*#if (!defined(EBMSMODULEVERSION))
#error You need to specify the EBMSMODULEVERSION define
#endif*/
...
#define EBMS_MODULE_SafetyTemperatureCutoff (int16_t)90
