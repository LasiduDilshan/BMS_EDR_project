...
$("#currentmonitor").text("EBMS Amperemeter");
...
//EBMS supports relay modules to safely disconnect chargers, contactors or consumers. The rules allow you to configure the relays for your situation.
$("#rt1").text("EBMS unterstützt Relais zum sicheren Trennen von Ladegeräten, Schützen oder Verbrauchern. Mit den Regeln können Sie die Relais für Ihre Situation konfigurieren.");
...
//WARNING
$("#ap5").text("WARNUNG");
//This is a E product/solution so don’t use this for safety critical systems or in any situation where there could be a risk to life.
$("#ap6").text("Dies ist ein E-Produkt/E-Lösung. Verwenden Sie dieses Produkt/Lösung daher nicht für sicherheitskritische Systeme oder in Situationen, in denen Lebensgefahr besteht.");
...
//EBMS supports up to 100 modules in total. These modules can be split into banks to support parallel configurations.
$("#mb2").text("EBMS unterstützt insgesamt bis zu 100 Module. Diese Module können in Bänke aufgeteilt werden, um parallele Konfigurationen zu unterstützen.");
...
//EbmsCurrentMonitorPage

//<h1>EBMS Current &amp; Voltage Monitor</h1>
$("#EbmsCurrentMonitorPage > h1").text("EBMS Ampere & Spannungsüberwachung");
