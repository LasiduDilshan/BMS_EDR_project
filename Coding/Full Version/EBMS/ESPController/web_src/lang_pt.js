...
$("#currentmonitor").text("Monitor de corrente EBMS");
...
$("#rt1").text("EBMS suporta módulos de relé para desligar carregadores, contatores ou consumidores com segurança. As regras permitem que configure os relés para a sua situação.");
...
$("#mb2").text("EBMS suporta até 100 módulos no total. Esses módulos podem ser divididos em bancos para suportar configurações paralelas.");
