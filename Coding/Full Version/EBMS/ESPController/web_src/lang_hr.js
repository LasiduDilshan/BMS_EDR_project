...
$("#currentmonitor").text("EBMS Amperemetar");
...
$("#rt1").text("EBMS podržava releje za sigurno odvajanje punjača, sklopnika ili potrošača. Pravila vam omogućuju da konfigurirate releje za svoju situaciju.");
...
$("#ap6").text("To je E proizvod / E rješenje. Stoga nemojte koristiti ovaj proizvod / rješenje za sustave koji su kritični za sigurnost ili u situacijama u kojima postoji opasnost za život");
...
$("#mb2").text("EBMS podržava ukupno do 100 modula. Ovi moduli mogu se podijeliti na Blokove kako bi podržali paralelne konfiguracije.");
