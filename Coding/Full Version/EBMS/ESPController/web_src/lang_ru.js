...
$("#currentmonitor").text("EBMS - токовый шунт");
...
$("#rt1").text("EBMS поддерживает реле для безопасного переключения зарядных устройств, контакторов и потребителей. Приведенные ниже правила позволяют вам настроить их для вашей ситуации");
...
$("#mb2").text("EBMS поддерживает в общей сложности до 100 модулей.  Эти модули могут быть разделены на разные банки для параллельной конфигурации");
...
$("#EbmsCurrentMonitorPage > h1").text("Контроль тока и напряжения EBMS");
$("#EbmsCurrentMonitorPage > div:nth-child(2) > h2").text("Подключение");
...
$("#b4").text("Монитор тока EBMS использует максимальную шкалу 40,96 мВ, поэтому шунтирующие напряжения, превышающие эту шкалу, будут пропорционально уменьшены.");
...
$("#EbmsCurrentMonitorForm2 > div > div:nth-child(2) > label").text("Выходное напряжение шунта (мВ)");
$("#RS485Form > div > button").text("Сохранить");
$("#EbmsCurrentMonitorForm1 > div > button").text("Сохранить");
$("#currentmonbasic > h2").text("Базовые настройки");
$("#EbmsCurrentMonitorForm2 > div > div:nth-child(3) > label").text("Емкость аккумулятора (Ач)");
$("#EbmsCurrentMonitorForm2 > div > div:nth-child(4) > label").text("Напряжение полного заряда");
$("#EbmsCurrentMonitorForm2 > div > div:nth-child(5) > label").text("Остаточный ток (Ампер)");
$("#EbmsCurrentMonitorForm2 > div > div:nth-child(6) > label").text("КПД заряда %");
$("#EbmsCurrentMonitorForm2 > div > div:nth-child(7) > label").text("Допустимые значения?");
$("#EbmsCurrentMonitorForm2 > div > div:nth-child(8) > label").text("Последнее сообщение (миллисекунды)");
$("#EbmsCurrentMonitorForm2 > div > div:nth-child(9) > label").text("Watchdog-счетчик");
$("#EbmsCurrentMonitorForm2 > div > div:nth-child(10) > label").text("Температура ядра процессора");
$("#EbmsCurrentMonitorForm2 > div > div:nth-child(11) > label").text("Значение тока шунта мВ");
$("#EbmsCurrentMonitorForm2 > div > div:nth-child(12) > label").text("Текущий размер LSB");
$("#EbmsCurrentMonitorForm2 > div > div:nth-child(13) > label").text("Сопротивление шунта");
$("#EbmsCurrentMonitorForm2 > div > div:nth-child(14) > label").text("Модель датчика");
$("#EbmsCurrentMonitorForm2 > div > div:nth-child(15) > label").text("Версия прошивки");
$("#EbmsCurrentMonitorForm2 > div > div:nth-child(16) > label").text("Дата прошивки");
$("#EbmsCurrentMonitorForm2 > div > div:nth-child(17) > label").text("Состояние реле");
$("#EbmsCurrentMonitorForm2 > div > div:nth-child(18) > label").text("Температура выше предельной");
$("#EbmsCurrentMonitorForm2 > div > div:nth-child(19) > label").text("Ток выше предела");
$("#EbmsCurrentMonitorForm2 > div > div:nth-child(20) > label").text("Ток ниже предела");
$("#EbmsCurrentMonitorForm2 > div > div:nth-child(21) > label").text("Напряжение выше предела");
$("#EbmsCurrentMonitorForm2 > div > div:nth-child(22) > label").text("Напряжение ниже предельного");
$("#EbmsCurrentMonitorForm2 > div > div:nth-child(23) > label").text("Мощность выше предела");
$("#EbmsCurrentMonitorForm2 > div > button:nth-child(24)").text("Сохранить");
...
$("#EbmsCurrentMonitorForm3 > div > div:nth-child(1) > label").text("Калибровка");
$("#EbmsCurrentMonitorForm3 > div > div:nth-child(2) > label").text("Температурный предел");
$("#EbmsCurrentMonitorForm3 > div > div:nth-child(3) > label").text("Предел пониженного напряжения");
$("#EbmsCurrentMonitorForm3 > div > div:nth-child(4) > label").text("Предел перенапряжения");
$("#EbmsCurrentMonitorForm3 > div > div:nth-child(5) > label").text("Превышение предела тока");
$("#EbmsCurrentMonitorForm3 > div > div:nth-child(6) > label").text("Пониженный предел тока");
$("#EbmsCurrentMonitorForm3 > div > div:nth-child(7) > label").text("Превышение предела мощности");
$("#EbmsCurrentMonitorForm3 > div > div:nth-child(8) > label").text("Температурный коэффициент ppm");
$("#EbmsCurrentMonitorForm3 > div > button").text("Сохранить");
$("#b10").text("Настройки реле контроля тока и Температурного коэффициента");
$("#EbmsCurrentMonitorForm4 > div > div:nth-child(1) > label").text("Температурный коэффициент включен");
$("#EbmsCurrentMonitorForm4 > div > div:nth-child(2) > label").text("Срабатывание реле: Температура");
$("#EbmsCurrentMonitorForm4 > div > div:nth-child(3) > label").text("Срабатывание реле: Превышение тока");
$("#EbmsCurrentMonitorForm4 > div > div:nth-child(4) > label").text("Срабатывание реле: Ток пониженный");
$("#EbmsCurrentMonitorForm4 > div > div:nth-child(5) > label").text("Срабатывание реле: Превышение напряжения");
$("#EbmsCurrentMonitorForm4 > div > div:nth-child(6) > label").text("Срабатывание реле: Напряжение пониженное");
$("#EbmsCurrentMonitorForm4 > div > div:nth-child(7) > label").text("Срабатывание реле: Мощность");
$("#EbmsCurrentMonitorForm4 > div > button").text("Сохранить");
...
$("#v1").text("Эта функция позволяет EBMS предоставлять данные о батарее и BMS устройствам Victron GX, используя протокол Victron CAN BMS.");
...
$("#v3").text("EBMS будет посылать сигналы тревоги на устройство Victron на основе правил для низких / высоких напряжений и температур.");
