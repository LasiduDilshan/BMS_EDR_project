...
env.Replace(PROGNAME="Ebms_controller_firmware_%s_%s" %
            (env["PIOPLATFORM"], env["PIOENV"]))


env.Replace(ESP8266_FS_IMAGE_NAME="Ebms_controller_filesystemimage_%s_%s" %
            (env["PIOPLATFORM"], env["PIOENV"]))

env.Replace(ESP32_SPIFFS_IMAGE_NAME="Ebms_controller_filesystemimage_%s_%s" %
            (env["PIOPLATFORM"], env["PIOENV"]))
