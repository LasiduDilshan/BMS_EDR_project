#ifndef EBMSWebServer_Json_Post_H_
#define EBMSWebServer_Json_Post_H_
...
extern Ebms_eeprom_settings mysettings;
...
extern void DefaultConfiguration(Ebms_eeprom_settings *_myset);
